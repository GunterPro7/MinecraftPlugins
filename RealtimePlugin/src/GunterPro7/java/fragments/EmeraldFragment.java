...
public class EmeraldFragment extends ItemStack {
    public static final int UNIQUE_NUMBER = 404104;
    ...
    public EmeraldFragment() {
        ...
        itemMeta.setDisplayName(ChatColor.GREEN + "Emerald Fragment");
        List<String> lore = new ArrayList<>();
        lore.add("§7This Fragment can be used to Craft the " + ChatColor.GOLD + "Ruby Armor" + "§7!");
