...
public class CraftingFragment extends ItemStack {
    public static final int UNIQUE_NUMBER = 404107;
    ...
    public CraftingFragment() {
        ...
        itemMeta.setDisplayName(ChatColor.GREEN + "Crafting Fragment");
        List<String> lore = new ArrayList<>();
        lore.add("§7This Fragment can be used to Craft the " + ChatColor.GOLD + "Auto Crafter" + "§7!");
